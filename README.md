...
![](https://github.com/Werayootk/React-food-order/blob/main/images/food.gif)
...
1. Clone this repo
   ```sh
   git clone https://github.com/Your_username/React-food-order.git
   ```
2. Install NPM packages
   ```sh
   npm install
   ```
3. Create Project in firebase and get start realtime database then copy link connection to change in `Cart.js` and `AvailableMeals.js`
...
This project got inspire from https://www.udemy.com/course/react-the-complete-guide-incl-redux/
